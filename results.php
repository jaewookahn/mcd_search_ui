...
<div class="container">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="vocab">
			...
			<p><span class="glyphicon glyphicon-th-list"></span> displays hierarchy (please wait for window to load)<br><span class="glyphicon glyphicon glyphicon-search">Adds term to Artstor mapping list
			</p>
			<div class ="row">
				<?php 
					...
					$url = "http://rack90.cs.drexel.edu:8080/MCD3/SearchGroupedConcepts?q=$query";
					...
					for ($i = 0, $size = count($data); $i < $size; ++$i) { // entire json array
						...
						$c= count($data[$i]['concepts']);
							...
							foreach ($data[$i]['concepts'] as $z){ //concepts array for each facet
								echo '<tr>';
								echo '<td><a href="#" class="openBtn" title ="' . $z['id'] . '"><span class="glyphicon glyphicon-th-list"></span></a> ' . $z['preferredstring'] . ' ( '. $z['id'] . ' ) 
								<a href="#" data-tab-destination="tab-2" title ="' . $z['id'] . '" data-term="' . $z['preferredstring'] . '" class="insert">
		...
		<div class="tab-pane" id="artstor-images">
			<div class ="row">
				<div class="col-md-12">
					<h3>Instructions: </h3>
					<ol>
						<li>Click "Map it!" to map Getty terms to Artstor.</li>
						<li>Click "Image Search!" to search for Artstor Images using Artstor terms.</li>
						<li>Browse the resulting Artstor Images.</li>
					</ol>
				</div>
			</div>
			<div class ="row">
			...
			<div class ="row">
				<div class="col-md-12">
					<h4><span class="label label-default">3 </span> &nbsp;ArtStor Images</h4>
				</div>
			</div>
